...
function databaseUrl() {
  ...
  // The Vercel Neon integration is connected with a SWAG prefix so it cannot
  // overwrite the existing project variable named DATABASE_URL.
  return [
    process.env.SWAG_DATABASE_URL,
    process.env.SWAG_POSTGRES_URL,
    process.env.SWAG_POSTGRES_PRISMA_URL,
